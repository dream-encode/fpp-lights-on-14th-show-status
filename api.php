...
function getEndpointsfpplightson14thshowstatus() {
    $result = array();

    $ep = array(
        'method'   => 'GET',
        'endpoint' => 'schedule',
        'callback' => 'fppLO14GetSchedule',
	);
...
function fppLO14GetSchedule() {
    $result            = array();
    $result['version'] = 'fpp-lights-on-14th-show-status v1.0.0';
